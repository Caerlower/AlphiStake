...
import stakingRewardsAbi from '../abis/StakingRewards.json'; // ABI for the StakingRewards contract// ABI for CryptograinToken
...
const Staking = () => {
  ...
  const fetchStakingData = async () => {
    try {
      ...
      const tokenContract = new ethers.Contract(tokenContractAddress, stakingRewardsAbi, signer);
      ...
      {loading ? (
        ...
        <div>
          <div className="staking-info">
            <h3>Your Staking</h3>
            <p><strong>Staked Balance:</strong> {stakedBalance} ALPH</p>
            <p><strong>Rewards Balance:</strong> {rewardsBalance} ALHP</p>
          ...
          <div className="stake-tokens">
            ...
            <input
              ...
              placeholder="Amount to stake in ALPH"
              value={stakeAmount}
